...
import com.example.wangzhibo.lovestudy.view.recyclerview.TestRecyclerViewActivity;
...
public class MainActivity extends Activity implements View.OnClickListener, ServiceConnection {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    findViewById(R.id.btn_jump_test_recyclerview).setOnClickListener(this);
    initAnimViews();
...
//        }
  ...
  public void onClick(View v) {
    switch (v.getId()) {
      case R.id.btn_jump_test_recyclerview:
        startActivity(TestRecyclerViewActivity.createIntent(MainActivity.this));
        break;
